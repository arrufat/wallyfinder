...
setup(
    name=f"wallyfinder{PACKAGE_NAME_POSTFIX}",
    version="1.0.0",
    author="Adrià Arrufat",
    author_email="adria.arrufat@outlook.com",
    description='A simple solver for "Where\'s Wally" images',
    long_description="It currently supports only Wally",
    ext_modules=[CMakeExtension("wallyfinder")],
